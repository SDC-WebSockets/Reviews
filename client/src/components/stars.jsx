...
import { StarsStyle } from '../styles.js';
...
const makeStar = (starFill) => {
  ...
  return (
    <svg viewBox="0 0 24 24" width="20" height="20">
      ...
      <path d="M 12 17.27 L 18.18 21 l -1.64 -7.03 L 22 9.24 l -7.19 -0.61 L 12 2 L 9.19 8.63 L 2 9.24 l 5.46 4.73 L 5.82 21 L 12 17.27 Z" strokeWidth="1" stroke="rgb(235, 138, 47)" fill={starTypes[starFill * 2]}></path>
    </svg>
  );
};
